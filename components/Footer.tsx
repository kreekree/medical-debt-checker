    ...
    <footer className="bg-slate-950 text-slate-400 py-12">
      <div className="max-w-5xl mx-auto px-4 sm:px-6">
        <div className="grid sm:grid-cols-3 gap-8 mb-10">
          <div>
            ...
            <p className="text-sm leading-relaxed">
              A free informational tool helping Americans understand wage garnishment rules across all 50 states.
            </p>
          </div>
          <div>
        ...
        <div className="border-t border-slate-800 pt-8">
          <div className="bg-amber-900/25 border border-amber-700/30 rounded-xl px-5 py-5 mb-6">
            <p className="text-amber-400 text-xs font-bold uppercase tracking-wider mb-2">Legal Disclaimer</p>
            <p className="text-amber-200/60 text-sm leading-relaxed">
              This site is for informational purposes only and does{' '}
              <strong className="text-amber-200/80">not constitute legal advice</strong>. Laws change frequently
              and vary by individual circumstances. Nothing on this site creates an attorney-client relationship.
              Always consult a licensed attorney in your state.
            </p>
          </div>
          <div className="flex flex-wrap justify-center gap-x-6 gap-y-2 text-xs text-slate-500 mb-3">
          ...
          <p className="text-xs text-slate-600 text-center">
            © 2026 WageGarnishmentLaws.com · Informational use only · Not affiliated with any government agency
          </p>
        </div>
      </div>
    </footer>
